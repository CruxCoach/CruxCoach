...
typealias QuantumBoardPoint = BoardPoint
...
const val QUANTUM_DIODE_DIAMETER_DP = 20f
const val QUANTUM_DIODE_STROKE_DP = 4f

/** Original touch acquisition radii: Belay is intentionally much tighter. */
fun quantumHitRadiusDp(model: QuantumBoardModel): Float =
