...
case "$scenario" in
  log/new-send|log/new-attempt|log/edit-send|log/saving|log/success|log/error|logbook/content|browser/content|browser/empty|browser/error|session/active|session/resting|session/paused|session/active-no-climb|progress/history|progress/empty|progress/error|progress/action-error|detail/disconnected|detail/connected) ;;
