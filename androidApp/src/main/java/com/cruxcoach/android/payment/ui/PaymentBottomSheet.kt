        ...
        Column(
            ...
            if (isSending) {
                ...
                PaymentOptionRow(
                    ...
                    subtitle = stringResource(R.string.payment_lightning_private_subtitle),
                    onClick = onSelectLightningPrivate
                )

                PaymentOptionRow(
                    icon = "\u26A1",
                    title = stringResource(R.string.payment_lightning_zap_title),
                    subtitle = stringResource(R.string.payment_lightning_zap_subtitle),
