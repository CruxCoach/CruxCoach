    ...
    when {
        ...
        state.climb != null -> {
            ClimbDetailProductionHeroHost(
                ...
                onNavigateToSetter = onNavigateToSetter,
                onNavigateToBugReport = onNavigateToBugReport,
                bleBugReportTitle = bleBugReportTitle,
                onFixBoardMismatch = onFixBoardMismatch,
                modifier = modifier,
            )
        }
    }
...
@Composable
internal fun CompactClimbOverview(
    state: ClimbDetailState,
    onShowDetails: () -> Unit,
