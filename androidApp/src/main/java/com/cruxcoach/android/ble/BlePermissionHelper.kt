...
object BlePermissionHelper {
     ...
     *
     * Location only ever gates BLE *scanning*, and only below API 31:
     ...
     *  - API 30 and below: the OS suppresses scan results while location
    ...
    fun isLocationRequired(apiLevel: Int, flowNeedsScan: Boolean, locationEnabled: Boolean): Boolean =
        flowNeedsScan && apiLevel < Build.VERSION_CODES.S && !locationEnabled
}
