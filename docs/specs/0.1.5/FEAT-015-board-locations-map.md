...
┌──────────────────────────────────────┐
│ ━━━                                   │ drag handle
│ Example Bouldering                    │ name (h6)
│ Sydney, Australia                     │ city + country (caption)
├──────────────────────────────────────┤
│ 📍 1 Example St, Sydney, ...          │ address
│ 📞 02 0000 0000                       │ phone (tap = dial)
│ ✉  hello@example.com                  │ email (tap = compose)
│ 🌐 example.com                        │ website (tap = open)
├──────────────────────────────────────┤
