...
The kilter-re workspace (`~/kilter-re/analysis/`) holds the official
...
Action: validate this table against `~/kilter-re/analysis/FINDINGS.md`
...
All dry-run outputs go to `~/cruxcoach-internal-archive/homewall-dry-runs/<YYYYMMDDTHHMMSSZ>/`
