...
Aurora and Kilter formats exists at the internal research archive.
...
**Location:** a private companion repo (not public)
**Pattern:** Identical to its sibling donations job (Python + cron + git state)
...
692 mappings Aurora → Kilter at the internal research archive.
