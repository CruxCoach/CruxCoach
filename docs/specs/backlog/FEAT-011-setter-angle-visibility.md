...
status: backlog
---
# Feature Spec: Setter Angle Visibility (backlog)
...
>
> **Prior status:** Skeleton — UX problem and rough surfaces identified.
...
**174,218 climbs** (per `the catalogue build pipeline/metrics.csv` row
...
- **Cron mapping** (`the catalogue build pipeline/update_board_db.py`):
