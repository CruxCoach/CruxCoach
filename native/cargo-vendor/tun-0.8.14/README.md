...
> [!NOTE]
> The method for retrieving file descriptor (tunFd) only works for iOS 14 and earlier.
> And [this issue](https://github.com/meh/rust-tun/issues/140) provides a solution for iOS 15 and later.
```swift
// Swift
